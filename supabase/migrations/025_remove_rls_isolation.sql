-- ============================================================
-- Migration 025: REMOVER ISOLAMENTO DE EMPRESAS POR USUÁRIO (BPO COMPARTILHADO)
-- Permite que qualquer usuário autenticado enxergue e gerencie
-- todas as empresas e seus dados (contas a pagar, vendas, etc.).
-- ============================================================
